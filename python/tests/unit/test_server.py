...
def test_sysinfo(mock_generators):
    mock_sysinfo_generator, _, _, _, _, _ = mock_generators
...
def test_highlights(mock_generators):
    _, _, _, _, _, mock_get_highlights = mock_generators
...
def test_install_model(mock_generators):
    _, _, mock_install_generator, _, _, _ = mock_generators
...
def test_run_model(mock_generators):
    _, _, _, mock_run_models_generator, _, _ = mock_generators
    response = client.post(
...
def test_stop_model(mock_generators):
    _, _, _, _, mock_stop_model_handler, _ = mock_generators
...
def test_delete_model(mock_generators):
    _, mock_delete_model_handler, _, _, _, _ = mock_generators
