...
const ModelWidget = ({
  ...
  const installIcon =
    process.env.NODE_ENV === "development"
      ...
      : "../../renderer/main_window/assets/icons/install.svg";
  const errorIcon =
    process.env.NODE_ENV === "development"
        ...
        return (
          <div className="h-[32.73px] w-[32.73px] absolute bottom-0 right-0 m-2 bg-[#D9D9D94D] z-[99999] rounded-full">
            <img
              src={installIcon}
              alt=""
              className="h-[32.73px] w-[32.73px] animate-spin"
            />
          </div>
        );
      case "NOT_DOWNLOADED":
        return (
          <div
            ...
            className={`h-[32.73px] w-[32.73px] absolute bottom-0 right-0 m-2 bg-[#D9D9D94D] rounded-full transition transition-200 z-[99999] widget-3d ${
      ...
      case "STOPPED":
        return (
          <div
            ...
            className={`h-[32.73px] w-[32.73px] absolute bottom-[50%] translate-y-[50%] left-[50%] translate-x-[-50%] bg-[#D9D9D94D] rounded-full transition transition-200 z-[99999] widget-3d `}
          >
