...
const Search: React.FC<SearchProps> = ({ recentlyUsedModels }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      <div className="flex flex-col w-full mt-[120px] max-w-[660px] justify-start items-center">
        <div className="w-full relative">
          <Input
            ...
            placeholder="Search..."
            className="h-[38px] bg-transparent text-[32px] border-none relative z-10 text-white"
          />
          <Input
        ...
        {search.length < 1 ? (
          ...
          <div className="flex flex-col gap-8 w-full justify-start items-center">
            {loadingState ? (
              <>loading...</>
            ) : (
              <>
              <div className="w-full mt-14 flex justify-between gap-8">
