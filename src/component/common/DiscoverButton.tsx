...
const DiscoverButton = () => {
  ...
  return (
    <div className="flex justify-between items-center rounded-md p-[6px] pr-4 gap-5 shadow-md bg-white/30 backdrop-blur-[24px] bg-opacity-10 w-[265px]">
      <span className="flex-center gap-1.5 ">
        <img src={discoverLogo} alt="discover" className="w-[25px] h-[25px]" loading="lazy"/>
        <span>Discover</span>
      </span>
      <img src={downloadIcon} alt="" className="w-[12px] h-[12px]" />
    </div>
  );
};
