...
const UpdateTruffle = ({className, ...props}: React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div className={`min-w-[240px] glass-3d pl-[14px] pr-[10px] py-[10px] bg-black/10 hover:bg-black/[15%] rounded-2xl transition ease-out 0.5s cursor-pointer ${className}`} {...props}>
      <span className='flex justify-between items-center gap-3'>
        ...
        <span className='mr-5'>
          ...
          <p className='text-sm font-normal -mt-1'>Update OS version</p>
        </span>
