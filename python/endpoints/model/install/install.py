...
async def install_generator(model_id: str, model_url: str, installation_manager: InstallationManager):
    """
    ...
    progress_event = {"id": model_id, "status": "INSTALLING",
    ...
    if does_quantization_exist(model_id, quantization):
        ...
        progress_event = {"id": model_id, "status": "DONE",
                          "progress": 100, "error": None}
        yield f"data: {json.dumps(progress_event)}\n\n"
