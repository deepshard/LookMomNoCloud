...
const PreOrderTruffle = () => {
  ...
  return (
    <div className="group transition ease-out duration-500 flex flex-col rounded-lg overflow-hidden w-full h-full relative p-[17px] pt-[20px] pb-[20px]">
      ...
      <div className="w-full flex flex-col justify-between items-start px-1 pb-3 rounded-lg">
        <div className="flex flex-col">
          <p className="text-surface-500 text-xs">$1,499.00</p>
          <p className="-mt-1 text-surface-main text-xl">Truffle–1</p>
        </div>
        <button
          className="h-0 h-10 outline-none opacity-100 transition ease-out duration-500 w-full mt-2 !px-2.5 rounded-sm bg-transparent  hover:bg-bg-wdget border-none glass-3d text-surface-main"
